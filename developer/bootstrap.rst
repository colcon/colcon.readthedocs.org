...
.. note::
    ...
    The following steps use the command line tool `vcs2l <https://github.com/ros-infrastructure/vcs2l>`_ to fetch a set of repositories.
    You can e.g. install it using ``pip install vcs2l``.
